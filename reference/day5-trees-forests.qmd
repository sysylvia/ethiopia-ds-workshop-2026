...
subtitle: "Day 5: Machine Learning for Causal Inference"
author: "Causal Inference and Machine Learning Workshop"
date: "July 18, 2025"
format:
  revealjs:
    theme: default
    ...
    footer: "Causal ML Workshop - Tree-based Methods"
---
...
- 9:00-10:00: Guest lecture by Professor Pan
- 10:15-11:00: Tree-based Methods (this session)
- 11:00-12:00: Causal ML for ATE estimation

**Afternoon**

- 12:00-12:45: Lunch break
- 12:45-1:30: Student presentation preparation
- 1:30-3:30: Heterogeneous Treatment Effects
...
::: {.column width="40%"}
![](media/lasso-contours.png){width="100%"}
...
::: {.column width="40%"}
![Variable selection across 10 iterations of Lasso on the same dataset. Black indicates selected; white indicates excluded. Notice the inconsistent pattern of selection.](media/lasso_stability.png){width="150%"}
:::
:::::

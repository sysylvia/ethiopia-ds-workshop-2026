...
::: fragment
**The WISE Project Goal:** Build local capacity to apply data-driven methods to these challenges.
:::
...
![The workshop pipeline: from data through ML models and simulation to policy insights](../images/workshop-pipeline.png){fig-alt="Flowchart showing workshop pipeline: Historical Data (facility reports, inventory levels, demand patterns) flows to ML Models (demand forecasting, risk prediction, Days 2-3) flows to Agent-Based Model (supply chain simulation, policy scenarios, Days 3-4) flows to Policy Insights (optimal allocation, intervention design, evidence for decisions)" width="95%"}
...
::: {.column width="50%"}
### What You Bring
- Understanding of Ethiopia's health system
...
|------|---------|-------------|
| **10:30-10:50** | *Break* | Coffee/tea available |
| **10:50-12:30** | Reproducible Research | Project structure, version control basics |
| **1:30-3:00** | Data Science in Policy | Real-world applications (Dr. Ozawa) |
| **3:20-5:00** | Hands-on Setup | Get your environment ready |

...
::: {.column width="55%"}
![Bias-variance tradeoff visualization. The blue curve represents test error, while the red curve shows training error. The gap widens as model complexity increases, indicating overfitting.](../images/bias_variance_tradeoff.png)
:::
:::::
...
::: {.column width="60%"}
![](../images/lasso-contours.png){width="150%"}
...
![Each line is a coefficient. Lambda is "relaxed" moving from left to right](../images/lambda.png)
...
::: {.column width="65%"}
![](../images/lasso_vs_ridge_vs_en.png){width="125%"}
...
::: {.column width="40%"}
![Variable selection across 10 iterations of Lasso on the same dataset. Black indicates selected; white indicates excluded. Notice the inconsistent pattern of selection.](../images/lasso_stability.png)
:::
:::::
...
![](../images/titanic.png){width="150%"}

## Example: Surviving the Titanic

![](../images/titanic2.png){width="150%"}

## Age, Class and Survival

![](../images/age_class.png){width="150%"}

## Age, Class and Survival

![](../images/age_class2.png){width="150%"}

## Age, Class and Survival

![](../images/age_class3.png){width="150%"}

## Age, Class and Survival

![](../images/age_class4.png){width="150%"}
...
![](../images/bag_titanic.png){width="150%"}

## Bagging Trees

![](../images/bag_titanic2.png){width="150%"}
...
![](../images/bag_titanic3.png){width="150%"}
